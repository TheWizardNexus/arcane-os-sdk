...
function validateRelease(value){
    ...
    if(value.sdkVersion!=='0.1.0-dev.0')fail('Runtime manifest sdkVersion is incompatible with this SDK.');
    if(!value.source||typeof value.source!=='object'
        ...
        ||value.source.bundleVersion!=='0.8.10'||value.source.protocol!=='arcane/1'){
